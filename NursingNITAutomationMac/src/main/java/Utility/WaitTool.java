...
public class WaitTool {
	...
	public static WebElement waitForElementDisplay(WebDriver driver,
			final By by, int timeOutInSeconds) {
		WebElement element;
		try {
			driver.manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS); // nullify
	 ...
	 *            The driver object to be used to wait and find the element
	 * @param String
	 *            The javaScript condition we are waiting.
	 * @param int The time in seconds to wait until returning a failure
	 * 
	...
	/**
	 * This method is to find an element within a particular timeout with
	 * polling of some seconds
	 * 
	 * @param driver
	 * @param by
	 * @param timeout
	 ...
	 * @return
	 */
	public WebElement fluentWait(WebDriver driver, final By by, int timeout,
			int polling) {
